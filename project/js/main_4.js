...
document.getElementById('class-selector-4').addEventListener('change', function() {
  ...
  document.getElementById('class-name-4').innerText;
  updateStatsTable_4(classInstance.stats);
});

// Function to update the stats table dynamically
function updateStatsTable_4(stats) {
  const statsTable = document.getElementById('stats-table-4');
...
document.getElementById('class-selector-4').dispatchEvent(new Event('change'));