...
document.getElementById('class-selector-2').addEventListener('change', function() {
  ...
  document.getElementById('class-name-2').innerText;
  updateStatsTable_2(classInstance.stats);
});

// Function to update the stats table dynamically
function updateStatsTable_2(stats) {
  const statsTable = document.getElementById('stats-table-2');
...
document.getElementById('class-selector-2').dispatchEvent(new Event('change'));