...
document.getElementById('class-selector-1').addEventListener('change', function() {
    ...
    document.getElementById('class-name-1').innerText;
    updateStatsTable(classInstance.stats);
});

// Function to update the stats table dynamically
function updateStatsTable(stats) {
    const statsTable = document.getElementById('stats-table-1');
...
document.getElementById('class-selector-1').dispatchEvent(new Event('change'));
